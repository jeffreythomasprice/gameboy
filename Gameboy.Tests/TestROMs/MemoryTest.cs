...
public class MemoryTest
{
	...
	public void EnableAndDisableRegions()
	{
		...
		var videoData1 = CreateArray(Memory.VIDEO_RAM_END - Memory.VIDEO_RAM_START, 0x11);
		var spriteAttributeData1 = CreateArray(Memory.SPRITE_ATTRIBUTES_END - Memory.SPRITE_ATTRIBUTES_START, 0x22);
		...
		var videoData2 = CreateArray(Memory.VIDEO_RAM_END - Memory.VIDEO_RAM_START, 0x33);
		var spriteAttributeData2 = CreateArray(Memory.SPRITE_ATTRIBUTES_END - Memory.SPRITE_ATTRIBUTES_START, 0x44);
		...
		var videoData3 = CreateArray(Memory.VIDEO_RAM_END - Memory.VIDEO_RAM_START, 0x55);
		var spriteAttributeData3 = CreateArray(Memory.SPRITE_ATTRIBUTES_END - Memory.SPRITE_ATTRIBUTES_START, 0x66);
	...
	public void DMA()
	{
		...
		var data1 = CreateArray(200, 0x11);
		...
		memory.SpriteAttributeMemoryEnabled = false;
		var data2 = CreateArray(200, 0x22);
		...
		// re-enable that, but now do a weird address
		memory.SpriteAttributeMemoryEnabled = true;
		var data3 = CreateArray(200, 0x33);
	...
	private byte[] CreateArray(int length, byte startingValue)
	{
