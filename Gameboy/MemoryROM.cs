...
{
	public MemoryROM(ILoggerFactory loggerFactory, Cartridge cartridge, SerialIO serialIO, Timer timer, Video video) : base(loggerFactory, cartridge, serialIO, timer, video) { }
